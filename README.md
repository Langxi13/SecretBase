...
| 备份中心 | 手动/自动备份分离、独立备份列表、可配置自动保留数量、指定备份下载和三步恢复向导。 |
...
| Backup center | Separate manual and automatic backups, dedicated backup lists, configurable automatic retention, per-backup downloads, and a three-step restore wizard. |

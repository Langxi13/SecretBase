...
assertIncludes(appJs, 'ViewHelpers.aiActionTypeLabel', 'app.js 必须复用 AI 操作类型展示辅助');
assertIncludes(appJs, 'ViewHelpers.aiActionEntryLabel', 'app.js 必须复用 AI 条目标题展示辅助');
...
assertIncludes(appJs, 'window.SecretBaseAiView.createAiView', 'app.js 必须复用 AI 视图摘要模块');

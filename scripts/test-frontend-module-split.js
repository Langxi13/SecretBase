...
[
    'css/base.css?v=20260714-ai-v2',
    'css/workspace.css?v=20260714-ai-v2',
    'css/workspace-responsive.css?v=20260714-ai-v2',
    'css/workspace-polish.css?v=20260714-ai-v2',
    'css/modals.css?v=20260714-ai-v2',
    'css/form-controls.css?v=20260714-ai-v2',
    'css/ai-components.css?v=20260714-ai-v2',
    'css/ai-workspace.css?v=20260714-ai-v2',
    'css/ai-send-review.css?v=20260714-ai-v2',
    'css/management-components.css?v=20260714-ai-v2',
    'css/component-responsive.css?v=20260714-ai-v2',
    'css/visual-polish.css?v=20260714-ai-v2',
    'css/component-polish.css?v=20260714-ai-v2'
...
assertIncludes(indexHtml, 'js/pagination.js?v=20260714-ai-v2', '分页偏好工具必须拆到独立 JS 模块');
assertIncludes(indexHtml, 'js/toast.js?v=20260714-ai-v2', 'Toast 工具必须拆到独立 JS 模块');

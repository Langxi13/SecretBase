...
assertIncludes(indexHtml, 'css/visual-polish.css?v=20260710-ui-v64', '视觉增强样式必须拆到 visual-polish.css 并带版本号');
assertIncludes(indexHtml, 'css/component-polish.css?v=20260710-ui-v64', '组件增强样式必须拆到 component-polish.css 并带版本号');
assertIncludes(indexHtml, 'js/pagination.js?v=20260710-ui-v64', '分页偏好工具必须拆到独立 JS 模块');
assertIncludes(indexHtml, 'js/toast.js?v=20260710-ui-v64', 'Toast 工具必须拆到独立 JS 模块');

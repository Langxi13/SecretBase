...
assertIncludes(dialogs, 'novalidate', '同步配置必须使用应用内校验，避免浏览器原生校验吞掉错误提示');
assertIncludes(dialogs, 'syncSetupCanSubmit', '加入/创建按钮必须由统一交互状态控制');
assertIncludes(dialogs, 'syncSetupError || syncError', '同步配置错误必须显示在弹窗内');

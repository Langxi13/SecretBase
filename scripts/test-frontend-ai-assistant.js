...
assertNotIncludes(markup, '@click="openProfessionalAiTools" :disabled="aiAssistantBusy"', '发送过程中不得锁定专业工具入口');
assertNotIncludes(markup, '@click="openAssistantSettings" :disabled="aiAssistantBusy"', '发送过程中不得锁定服务设置入口');

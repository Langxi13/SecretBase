...
assertIncludes(indexHtml, '?v=20260709-ui-v52', '前端资源版本必须随 AI 交互标题修复更新，避免浏览器继续使用旧 JS');
assertNotIncludes(indexHtml, '?v=20260708-ui-v51', '不能继续引用旧资源版本，否则 AI 交互可能继续显示条目唯一代码');

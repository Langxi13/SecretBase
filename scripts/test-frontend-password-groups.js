...
assertIncludes(indexHtml, '?v=20260708-ui-v50', '前端资源版本必须随条目编辑交互更新，避免浏览器继续使用旧 JS');
assertNotIncludes(indexHtml, '?v=20260708-ui-v49', '不能继续引用旧资源版本，否则条目编辑弹窗可能继续显示旧 UI');

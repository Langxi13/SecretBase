...
assertIncludes(indexHtml, 'js/controllers/desktop-controller.js?v=20260714-ai-v8', '入口页必须加载桌面控制器');
assertIncludes(indexHtml, 'css/desktop-components.css?v=20260714-ai-v8', '入口页必须加载桌面样式');

...
[
    'js/view-helpers.js?v=20260714-ai-v8',
    'js/tag-view.js?v=20260714-ai-v8',
    'js/backup-view.js?v=20260714-ai-v8',
    'js/ai-view.js?v=20260714-ai-v8',
    'js/download-helper.js?v=20260714-ai-v8',
    'js/controllers/entry-controller.js?v=20260714-ai-v8',
    'js/controllers/group-controller.js?v=20260714-ai-v8',
    'js/controllers/tag-controller.js?v=20260714-ai-v8',
    'js/controllers/ai-settings-controller.js?v=20260714-ai-v8',
    'js/controllers/ai-controller.js?v=20260714-ai-v8',
    'js/controllers/ai-assistant-controller.js?v=20260714-ai-v8',
    'js/controllers/backup-controller.js?v=20260714-ai-v8',
    'js/controllers/trash-controller.js?v=20260714-ai-v8',
    'js/controllers/transfer-controller.js?v=20260714-ai-v8',
    'js/controllers/maintenance-controller.js?v=20260714-ai-v8',
    'js/controllers/list-controller.js?v=20260714-ai-v8',
    'js/ai-state.js?v=20260714-ai-v8',
    'js/app-state.js?v=20260714-ai-v8',
    'js/app-ui-controller.js?v=20260714-ai-v8',
    'js/app-data-controller.js?v=20260714-ai-v8',
    'js/ai-feature-composition.js?v=20260714-ai-v8',
    'js/app-feature-composition.js?v=20260714-ai-v8',
    'js/app-session-controller.js?v=20260714-ai-v8',
    'js/app-watchers.js?v=20260714-ai-v8',
    'js/app-template-context.js?v=20260714-ai-v8',
    'js/app.js?v=20260714-ai-v8'
].forEach(asset => {

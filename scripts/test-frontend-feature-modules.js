...
[
    'js/view-helpers.js?v=20260714-ai-v6',
    'js/tag-view.js?v=20260714-ai-v6',
    'js/backup-view.js?v=20260714-ai-v6',
    'js/ai-view.js?v=20260714-ai-v6',
    'js/download-helper.js?v=20260714-ai-v6',
    'js/controllers/entry-controller.js?v=20260714-ai-v6',
    'js/controllers/group-controller.js?v=20260714-ai-v6',
    'js/controllers/tag-controller.js?v=20260714-ai-v6',
    'js/controllers/ai-settings-controller.js?v=20260714-ai-v6',
    'js/controllers/ai-controller.js?v=20260714-ai-v6',
    'js/controllers/ai-assistant-controller.js?v=20260714-ai-v6',
    'js/controllers/backup-controller.js?v=20260714-ai-v6',
    'js/controllers/trash-controller.js?v=20260714-ai-v6',
    'js/controllers/transfer-controller.js?v=20260714-ai-v6',
    'js/controllers/maintenance-controller.js?v=20260714-ai-v6',
    'js/controllers/list-controller.js?v=20260714-ai-v6',
    'js/ai-state.js?v=20260714-ai-v6',
    'js/app-state.js?v=20260714-ai-v6',
    'js/app-ui-controller.js?v=20260714-ai-v6',
    'js/app-data-controller.js?v=20260714-ai-v6',
    'js/ai-feature-composition.js?v=20260714-ai-v6',
    'js/app-feature-composition.js?v=20260714-ai-v6',
    'js/app-session-controller.js?v=20260714-ai-v6',
    'js/app-watchers.js?v=20260714-ai-v6',
    'js/app-template-context.js?v=20260714-ai-v6',
    'js/app.js?v=20260714-ai-v6'
].forEach(asset => {

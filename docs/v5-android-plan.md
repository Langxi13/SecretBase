...
本机已通过 Flutter 分析、13 项 Dart/Widget 测试、Vault Core 7 项测试和移动端 Rust 22 项测试。Android CI 已通过三 ABI Release APK、隐私扫描及 API 29/36 模拟器，并保留可选持久签名流程；本机仅构建 arm64，避免在低内存服务器上并行编译。
